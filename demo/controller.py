...
class InteractiveController:
    # TODO:
    def __init__(self, net, device, update_image_callback, prob_thresh=0.5):
        self.net = net
    ...
    def set_image(self, image):
        ...
        pred = self.predictor.get_predictions_ori().astype(np.float32)
        torch.cuda.empty_cache()
        # self._result_mask = pred
    ...
    def add_click(self, x, y, is_positive):
        ...
        pred = self.predictor.get_predictions_refine(self.clicker, prev_mask=self._init_mask)
